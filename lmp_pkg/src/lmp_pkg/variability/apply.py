...
def _apply_inhalation_factors(
    ...
    factor_mapping = {
        "pifr_Lpm": "peak_inspiratory_flow_l_min",
        "rise_time_s": "flow_acceleration_s",
        "hold_time_s": "breath_hold_time_s", 
        "breath_hold_time_s": "breath_hold_time_s",
        "exhalation_flow_Lpm": "exhalation_time_s",  # Approximate mapping
        "bolus_volume_ml": "inhaled_volume_ml",
        "bolus_delay_s": "actuation_delay_s"
    }
...
def _apply_physiology_values(
    ...
    if "FRC" in values:
        subject_dict["frc_ml"] = values["FRC"]
