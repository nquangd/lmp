...
class LungEntity:
    ...
    def compute_derivatives(self, plasma_concentration, deposition_input, external_mcc_input):
        ...
        # Permeability fluxes - EXACT reference implementation with factor of 2.0
        ...
        paracellular_flux = 2.0 * self.perm_para * self.surface_area * (conc_elf_unbound - conc_tissue_unbound)
