...
def test_parameter_fitter_pk_only_workflow():
    ...
    params = [
        ParameterDefinition("volume_central_L", "iv_pk.params.volume_central_L", (10.0, 60.0)),
        ParameterDefinition("clearance_L_h", "iv_pk.params.clearance_L_h", (10.0, 200.0)),
    ]
