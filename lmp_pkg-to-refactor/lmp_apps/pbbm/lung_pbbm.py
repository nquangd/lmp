...
from ..population.attributes import SubjectPhysiology, GITract, GenerationPhysiology, RegionPhysiology
...
class PBPK_Model_Virtual_Trial:
    ...
    def __init__(self, subject, api, settings):
        self.physio, self.api, self.simtime = subject.RegionPhysiology, api, settings.simtime
        self.region = self.physio.region  # ['ET', 'BB', 'bb_b', 'Al']
        self.gi_tract = subject.GITract.get_subject_api(self.api)  # GI tract
        ...
        self.FRC = subject.FRC
        self.FRC_ref = subject.FRC_ref
    ...
    def precalculate_params_for_numba(self):
        ...
        frc_factor = (self.FRC / self.FRC_ref)**(1/3)
