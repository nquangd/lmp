...
class CleanDepositionParameters:
    ...
    frc_ml: float
    lung_geometry: np.ndarray  # Already scaled by subject.LungGeneration.lung_scaling()
...
class CleanLungDeposition(DepositionModel):
    ...
    def run(self, data: DepositionInput) -> DepositionResult:
        ...
        # Extract clean parameters (already transformed by physiology.py)
    ...
    def _calculate_regional_deposition(self, params: CleanDepositionParameters) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
        ...
        try:
            ...
            # Use lung geometry directly - already scaled by subject.LungGeneration.lung_scaling()
            ...
            # subject.LungGeneration.lung_scaling() returns columns:
            ...
            print(f"         - Current: lung_scaling(ref_lung, frc_ml) then pass frc_ml")
